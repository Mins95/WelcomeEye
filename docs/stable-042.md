...
- The CRC32C musl wheel patch is prepared and tested, but its upstream runtime rollout is not complete. This release does not install a native binary or suppress the Python-backend warning.
